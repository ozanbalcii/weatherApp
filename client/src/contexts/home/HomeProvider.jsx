...
const data = { weatherData, weatherDataForHomePage, locationDataForHomePage, loading, error,  handleSubmit, handleChange, values, touched, getFieldProps, errors, watchlist, setWatchlist }
  return (
